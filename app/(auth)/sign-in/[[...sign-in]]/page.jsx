...
export default function Page() {
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white shadow-md rounded-lg relative overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-5xl"> {/* Wider container, grid layout */}
